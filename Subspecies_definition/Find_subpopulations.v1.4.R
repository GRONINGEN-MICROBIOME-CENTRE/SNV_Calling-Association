...
source(file ="/groups/umcg-lifelines/tmp01/projects/dag3_fecal_mgs/umcg-dwang/SNP/subspecies/bin/Functions.v1.4.R")
...
Run_samplePickUp_and_cluster =  function(AF, Samples, Matrix, Number_samples = 0, Number_SNP = 0, Save=T){
	...
	write_rds(Matrix_clustering, "TEST.rds")
	...
	Clustering_results = Perform_clustering(Distance, PCs, threads = Multi_th)
...
Run_samplePickUp_and_cluster(AF, Samples, Matrix, Number_samples, Number_SNP, Save=T) -> Output
Output[[1]] -> PCOA
